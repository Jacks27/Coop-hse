...
my_v1.add_url_rule('/confirm_email/<token>', view_func=auth.confirm_email, methods=['POST'])
my_v1.add_url_rule('/forgot_password', view_func=auth.forgot_password, methods=['POST'])
my_v1.add_url_rule('/recover_account/<token>', view_func=auth.recover_account, methods=['POST','GET'])
